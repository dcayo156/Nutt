...
namespace NUT.LIB.NEG.EN
{
    ...
    public class CondicionNoPatologica : XP.EN.EntidadGen<CondicionNoPatologica>
    {

        public const string TABLA = "NEG.CondicionNoPatologica";

        #region Constructores

        public CondicionNoPatologica()
            : base()
        {
        }
        protected CondicionNoPatologica(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        protected override void CrearEsquema()
        {
            ...
            this.datos.Add("Nombre", new EntidadColumna("Nombre", null, Convert.ToInt32(DbType.AnsiString).ToString(), null, 30, null, null, 0, 0));
