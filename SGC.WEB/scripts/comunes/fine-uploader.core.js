    ...
    (function() {
        ...
        qq.FineUploaderBasic = function(o) {
            ...
            this._options = {
                ...
                messages: {
                    typeError: "El archivo {file} tiene una extensión inválida. Las extensiones válidas son: {extensions}.",
                    sizeError: "El archivo {file} es demasiado grande, el tamaño máximo es de {sizeLimit} bytes.",
                    minSizeError: "El archivo es demasiado pequeño, el tamaño mínimo es de {minSizeLimit} bytes.",
                    emptyError: "El archivo {file} está vacío, por favor seleccione otro conjunto de archivos que no lo incluya.",
