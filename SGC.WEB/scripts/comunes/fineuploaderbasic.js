...
qq.FineUploaderBasic = function (o) {
    ...
    this._options = {
        ...
        messages: {
            typeError: "El archivo {file} tiene una extensi\363n inv\341lida. Las extensiones permitidas son: {extensions}.",
            sizeError: "El archivo {file} es demasiado grande, el tama\361o m\341ximo permitido es {sizeLimit}.",
            minSizeError: "El archivo {file} es muy peque\361o, el tama\361o mínimo requerido es {minSizeLimit}.",
            emptyError: "El archivo {file} est\341 vacío, por favor seleccione archivos nuevamente sin éste.",
            noFilesError: "No hay archivos para subir.",
            tooManyItemsError: "Demasiados archivos ({netItems}) serían subidos. La cantidad límite es {itemLimit}.",
...
//#region deletefile.ajax.requester.js
...
//#region window.receive.message.js
