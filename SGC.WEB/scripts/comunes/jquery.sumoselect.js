...
(function ($) {
    ...
    $.fn.SumoSelect = function (options) {
        ...
        var settings = $.extend({
            ...
            triggerChangeCombinedXP: true,
            triggerChangeEfectivo: true
            ...
            this.sumo = {
                ...
                selAll: function () {
                    ...
                    O.chkAll.on('click', function () {
                        ...
                        if (settings.triggerChangeCombinedXP) {
                            settings.triggerChangeEfectivo = false;
                        }
                        ...
                        if (settings.triggerChangeCombinedXP) {
                            settings.triggerChangeEfectivo = true;
                            O.E.trigger('change');
                        }
                    });
                ...
                setOnOpen: function () {
                    var O = this;
                    var li = O.optDiv.find('ul li:first-child').eq(O.E[0].selectedIndex);
                    li.addClass('sel');
                    O.showOpts();
                },
                nav: function (up) {
                ...
                onOptClick: function (li) {
                    ...
                    li.click(function () {
                        ...
                        if (!(O.is_multi && settings.triggerChangeCombined && (O.is_floating || settings.okCancelInMulti))) {
                            O.setText();
                            if (settings.triggerChangeEfectivo) {
                                O.E.trigger('change').trigger('click');
                            }
                        }
